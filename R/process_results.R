...
process_results = function(args) {
  ...
  pas2080 <- data.frame(
    pas2080_code = c("A1","A2","A3","A4","A5",
                     ...
                     "C1","c2","C3","C4"),
    pas2080_name = c("Raw material supply","Transport","Manufacture",
                     "Transport to works site","Construction and installation processes",
                     "Use","Maintainance","Repair","Replacement","Refurbishment",
                     "Operational Energy Use","Operational Water Use",
                     "Other operational processes","Users utilisation of infrastructure",
                     "Deconstruction","Transport","Waste Processing for recovery","Disposal"),
    emissions = c(1:18),
