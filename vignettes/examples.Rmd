...
infra = read_sf("../data/map.geojson")
...
names(json) = c("user_input", "intervention_assets", "intervention_assets_parameters", "asset_components", "carbon_factors", "desire_lines", "path_dem","path_landcover","path_bedrock", "path_superficial", "material_sites")

#json = jsonlite::toJSON(json)
jsonlite::write_json(json,"../tests/testthat/bristol_cycling_example.json", pretty = TRUE)
```
